...
export default function Pricing() {
  return (
        ...
        <div>
           <div className="flex flex-col items-center justify-center mb-12  bg-white">
    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      ...
      <div className="flex flex-col rounded-lg border border-gray-200">
        <div className="grid gap-4 p-6">
          ...
          <p className="text-sm leading-6 text-gray-500">Perfect for individuals getting started</p>
      ...
      <div className="flex flex-col rounded-lg border border-gray-200">
        <div className="grid gap-4 p-6">
          ...
          <p className="text-sm leading-6 text-gray-500">For teams shipping quality projects</p>
      ...
      <div className="flex flex-col rounded-lg border border-gray-200">
        <div className="grid gap-4 p-6">
          ...
          <p className="text-sm leading-6 text-gray-500">Advanced features for large organizations</p>
